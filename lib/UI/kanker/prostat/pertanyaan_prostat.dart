...
import 'package:primafit/UI/kanker/prostat/output_prostat.dart';
import 'package:primafit/UI/kanker/prostat/list_pertanyaan.dart';

class KankerProstatPage extends StatefulWidget {
  const KankerProstatPage({Key? key}) : super(key: key);

...
class EditBpjsPage extends StatefulWidget {
  final int bpjsId;

  const EditBpjsPage({Key? key, required this.bpjsId}) : super(key: key);

  @override
  State<EditBpjsPage> createState() => _EditBpjsPageState();
}

class _EditBpjsPageState extends State<EditBpjsPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadBpjsData() async {
    ...
    try {
      ...
      if (bpjs != null) {
        ...
        _initialData = Map<String, dynamic>.from(bpjs);
        _originalName = bpjs['nama'];
  ...
  void _onFormChanged() {
    if (!_isFormDirty && _initialData != null) {
      if (_nomorController.text != _initialData!['nomor_bpjs'] ||
          _namaController.text != _initialData!['nama'] ||
  ...
  Future<void> _updateBpjs() async {
    ...
    try {
      ...
      final bpjsData = {
        'nomor_bpjs': _nomorController.text.trim(),
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                AnimatedContainer(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          'Anda sedang mengedit data BPJS untuk $_originalName',
                                          style: GoogleFonts.poppins(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w500,
                                          ),
                                ...
                                // Form field for BPJS number
                                TextFormField(
                                  controller: _nomorController,
                                  decoration: InputDecoration(
                                    labelText: 'Nomor Kartu BPJS',
                                    labelStyle: GoogleFonts.poppins(),
                                    hintText: 'Masukkan nomor kartu BPJS',
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (_nomorController.text != _initialData!['nomor_bpjs'])
                                          _buildChangeRow(
                                            'Nomor BPJS',
                                            _initialData!['nomor_bpjs'],
                                            _nomorController.text,
                                          ),
                                        if (_namaController.text != _initialData!['nama'])
                                          _buildChangeRow(
                                            'Nama',
                                            _initialData!['nama'],
                                            _namaController.text,
                                          ),
                                        if (_tanggalLahirController.text != _initialData!['tanggal_lahir'])
                                          _buildChangeRow(
                                            'Tanggal Lahir',
                                            _initialData!['tanggal_lahir'],
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              'Pastikan informasi yang Anda masukkan sesuai dengan kartu BPJS asli untuk menghindari masalah saat digunakan',
                                              style: GoogleFonts.poppins(
                                                fontSize: 13,
                                                color: Colors.grey[700],
                                              ),
            ...
            child: SafeArea(
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: (_isLoading || _isSaving) ? null : _updateBpjs,

...
import 'dart:async';
import 'package:primafit/database/skincare/database_exfoliator.dart';
import 'package:primafit/UI/skincare/exfoliator/output_exfoliator.dart';
import 'package:primafit/UI/skincare/exfoliator/list_pertanyaan.dart';

class ExfoliatorRecommendationPage extends StatefulWidget {
  const ExfoliatorRecommendationPage({Key? key}) : super(key: key);
    ...
    return AnimatedContainer(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          highlightColor: const Color(0xFF9C27B0).withOpacity(0.05),
          onTap: () {
            setState(() {

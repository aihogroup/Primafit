...
class UpdateGulaDarahScreen extends StatefulWidget {
  final int GulaDarahId;
  
  const UpdateGulaDarahScreen({
    Key? key,
    required this.GulaDarahId,
  }) : super(key: key);

  @override
  State<UpdateGulaDarahScreen> createState() => _UpdateGulaDarahScreenState();
}

class _UpdateGulaDarahScreenState extends State<UpdateGulaDarahScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadGulaDarahData() async {
    try {
      final data = await GulaDarahDatabaseHelper.instance.getGulaDarahById(widget.GulaDarahId);
      if (data != null) {
        setState(() {
          _currentData = data;
  ...
  void _updateData() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final updatedGulaDarah = GulaDarah(
          id: widget.GulaDarahId,
        ...
        await GulaDarahDatabaseHelper.instance.updateGulaDarah(updatedGulaDarah);
                  ...
                  child: Padding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Perbarui data pemeriksaan GulaDarah Anda',
                            style: GoogleFonts.poppins(
                              fontSize: 14,
                          ...
                          const SizedBox(height: 16),
                          Text(
                            'Hasil Periksa Kadar GulaDarah Total',
                            style: GoogleFonts.poppins(
                              fontSize: 16,
                              fontWeight: FontWeight.w500,
                            ),

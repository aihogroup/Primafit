...
class _LoginPageState extends State<LoginPage> 
  ...
  bool _validateCurrentPage() {
    switch (_currentPage) {
      ...
      case 1:
        ...
        String? phoneError = _validatePhoneNumber(_teleponController.text);
        if (phoneError != null) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: const Color(0xFF64D1DE).withOpacity(0.3),
          ),
        ),
        child: Column(
          children: [
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      // Clean phone number
      String cleanedPhone = _teleponController.text.replaceAll(RegExp(r'[^0-9]'), '');
  ...
  Widget _buildInfoCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF64D1DE).withOpacity(0.1),
        borderRadius: BorderRadius.circular(15),
        border: Border.all(color: const Color(0xFF64D1DE).withOpacity(0.3)),
      ),
      child: Row(
        children: [
          Icon(

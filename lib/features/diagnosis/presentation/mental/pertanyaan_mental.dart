...
import 'dart:async';
import 'package:primafit/features/diagnosis/data/database_mental.dart';
import 'package:primafit/features/diagnosis/presentation/mental/output_mental.dart';
import 'package:primafit/features/diagnosis/presentation/mental/list_pertanyaan.dart';
...
class _MentalPageState extends State<MentalPage> with SingleTickerProviderStateMixin {
  ...
  void _nextPage() {
    if (_currentPage < MentalQuestions.activeQuestions(_answers).length - 1) {
      _animateToNextPage();
    } else {
      _submitAnswers();
    }
  ...
  Future<void> _submitAnswers() async {
    ...
    for (var question in MentalQuestions.questions) {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(
                    'Pertanyaan ${index + 1}/${MentalQuestions.activeQuestions(_answers).length}',
                    style: GoogleFonts.poppins(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: Colors.grey.shade700,
                    ...
                    child: Stack(
                      children: [
                        AnimatedFractionallySizedBox(
                          duration: const Duration(milliseconds: 300),
                          widthFactor: (index + 1) / MentalQuestions.activeQuestions(_answers).length,
                          child: Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
              ...
              Row(
                ...
                children: [
                  ...
                  if (index < MentalQuestions.activeQuestions(_answers).length - 1)
                    ElevatedButton.icon(
      ...
      body: _loading
          ...
          : SafeArea(
              child: PageView.builder(
                ...
                itemCount: MentalQuestions.activeQuestions(_answers).length,
                itemBuilder: (context, index) {
                  return _buildQuestionPage(MentalQuestions.activeQuestions(_answers)[index], index);
                },
              ),
            ),
    );

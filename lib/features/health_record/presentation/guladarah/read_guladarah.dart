...
import 'package:primafit/features/health_record/presentation/guladarah/update_guladarah.dart';
import 'package:primafit/features/health_record/presentation/guladarah/input_guladarah.dart';

class ReadGulaDarahScreen extends StatefulWidget {
  const ReadGulaDarahScreen({super.key});
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final double valueInMmolL = item.getHasilInMmolL();

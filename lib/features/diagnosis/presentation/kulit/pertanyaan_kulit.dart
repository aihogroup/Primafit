...
import 'dart:async';
import 'package:primafit/features/diagnosis/data/database_kulit.dart';
import 'package:primafit/features/diagnosis/presentation/kulit/output_kulit.dart';
import 'package:primafit/features/diagnosis/presentation/kulit/list_pertanyaan.dart';

class kulitPage extends StatefulWidget {
  const kulitPage({super.key});

  @override
  _kulitPageState createState() => _kulitPageState();
}

class _kulitPageState extends State<kulitPage> with SingleTickerProviderStateMixin {
  ...
  void _nextPage() {
    if (_currentPage < KulitQuestions.getQuestionCount() - 1) {
      _animateToNextPage();
    } else {
      _submitAnswers();
    }
  ...
  Future<void> _submitAnswers() async {
    ...
    for (var question in KulitQuestions.getAllQuestions()) {
  ...
  Widget _buildAnswerButton(String answer, String questionId) {
    final bool isSelected = _answers[questionId] == answer;
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(
                    'Pertanyaan ${index + 1}/${KulitQuestions.getQuestionCount()}',
                    style: GoogleFonts.poppins(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: Colors.grey.shade700,
                    ...
                    child: Stack(
                      children: [
                        AnimatedFractionallySizedBox(
                          duration: const Duration(milliseconds: 300),
                          widthFactor: (index + 1) / KulitQuestions.getQuestionCount(),
                          child: Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
              ...
              Row(
                ...
                children: [
                  ...
                  if (index < KulitQuestions.getQuestionCount() - 1)
                    ElevatedButton.icon(
      ...
      body: _loading
          ...
          : SafeArea(
              child: PageView.builder(
                ...
                itemCount: KulitQuestions.getQuestionCount(),
                itemBuilder: (context, index) {
                  return _buildQuestionPage(KulitQuestions.getQuestionByIndex(index), index);
                },
              ),
            ),
    );
...
// import 'package:google_fonts/google_fonts.dart';
// import 'dart:async';
// import 'package:primafit/database/database_kulit.dart';
// import 'package:primafit/UI/kulit/output_kulit.dart';
// import 'package:primafit/UI/kulit/list_pertanyaan.dart';

// class kulitPage extends StatefulWidget {
//   const kulitPage({Key? key}) : super(key: key);
...
//   void _nextPage() {
//     if (_currentPage < KulitQuestions.activeQuestions(_answers).length - 1) {
//       _animateToNextPage();
//     } else {
//       _submitAnswers();
//     }
...
//     for (var question in KulitQuestions.questions) {
...
//             if (questionId == 'gatal' && answer == 'Tidak') {
//               _answers.remove('gatal_berdahak');
//               _answers.remove('gatal_berdarah');
//             }
...
//                 children: [
//                   Text(
//                     'Pertanyaan ${index + 1}/${KulitQuestions.activeQuestions(_answers).length}',
//                     style: GoogleFonts.poppins(
//                       fontSize: 14,
//                       fontWeight: FontWeight.w500,
//                       color: Colors.grey.shade700,
...
//                         AnimatedFractionallySizedBox(
//                           duration: const Duration(milliseconds: 300),
//                           widthFactor: (index + 1) / KulitQuestions.activeQuestions(_answers).length,
//                           child: Container(
//                             decoration: BoxDecoration(
//                               borderRadius: BorderRadius.circular(10),
//                               color: const Color(0xFF64D1DE),
...
//                   if (index < KulitQuestions.activeQuestions(_answers).length - 1)
//                     ElevatedButton.icon(
//                       onPressed: !_answers.containsKey(questionId) 
//                           ? null 
//                           : _nextPage,
...
//                 controller: _pageController,
//                 physics: const NeverScrollableScrollPhysics(),
//                 itemCount: KulitQuestions.activeQuestions(_answers).length,
//                 itemBuilder: (context, index) {
//                   return _buildQuestionPage(KulitQuestions.activeQuestions(_answers)[index], index);
//                 },
//               ),
//             ),
//     );

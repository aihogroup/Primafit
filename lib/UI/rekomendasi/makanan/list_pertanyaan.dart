...
class NutritionQuestions {
  ...
  static Map<String, dynamic> calculateNutritionNeeds(Map<String, dynamic> answers) {
    ...
    try {
      ...
      String tujuanDiet = answers['tujuan_diet'] ?? 'Pemeliharaan berat badan';
      ...
      double recommendedCalories = adjustCaloriesForGoal(tdee, tujuanDiet);
      
      // Calculate macronutrients based on goal and health condition
      Map<String, double> macros = calculateMacronutrients(
        recommendedCalories, 
        tujuanDiet, 
        kondisiKesehatan
      );
      ...
      String secondaryCategory = determineSecondaryCategory(tujuanDiet, answers);
  ...
  static Map<String, double> calculateMacronutrients(
    ...
    // Calculate grams
    double proteinGrams = (calories * proteinPercentage) / 4; // 4 calories per gram
    double carbGrams = (calories * carbPercentage) / 4; // 4 calories per gram
    double fatGrams = (calories * fatPercentage) / 9; // 9 calories per gram
  ...
  static String determineSecondaryCategory(String goal, Map<String, dynamic> answers) {
    String preferensiDiet = answers['preferensi_diet'] ?? 'Tidak ada preferensi khusus';

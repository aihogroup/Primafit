...
import 'package:primafit/UI/kewanitaan/parenting/beranda_parenting.dart';


class ParentingMenuPage extends StatefulWidget {
  const ParentingMenuPage({Key? key}) : super(key: key);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              padding: const EdgeInsets.all(20),
                              decoration: BoxDecoration(
                                color: const Color(0xFFE9458D).withOpacity(0.05),
                                borderRadius: BorderRadius.circular(16),
                                border: Border.all(
                                  color: const Color(0xFFE9458D).withOpacity(0.1),
                                ),

...
import 'package:primafit/UI/rekomendasi/olahraga/output_olahraga.dart';
import 'package:primafit/UI/rekomendasi/olahraga/list_pertanyaan.dart';
...
class _ExerciseAnalysisPageState extends State<ExerciseAnalysisPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _animateToPreviousPage() async {
    ...
    setState(() {
      ...
      String questionId = ExerciseQuestions.activeQuestions(_answers)[_currentPage]['id'];
  ...
  Widget _buildQuestionPage(Map<String, dynamic> question, int index) {
    ...
    String? inputType = ExerciseQuestions.getInputTypeForQuestion(questionId);

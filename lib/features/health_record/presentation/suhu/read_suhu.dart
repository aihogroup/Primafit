...
import 'package:primafit/features/health_record/presentation/suhu/update_suhu.dart';
import 'package:primafit/features/health_record/presentation/suhu/input_suhu.dart';

class ReadSuhuScreen extends StatefulWidget {
  const ReadSuhuScreen({super.key});
  ...
  String _getValueInSelectedUnit(String valueStr, String originalUnit) {
    ...
    if (_showAsCelsius) {
      if (originalUnit == '°C') {
        ...
        final double celsius = convertFahrenheitToCelsius(value);
      ...
      if (originalUnit == '°F') {
        ...
        final double fahrenheit = convertCelsiusToFahrenheit(value);
                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final double value = double.tryParse(item.hasil) ?? 0.0;

...
class EditDokumenPage extends StatefulWidget {
  ...
  const EditDokumenPage({Key? key, required this.dokumenId}) : super(key: key);
...
class _EditDokumenPageState extends State<EditDokumenPage> with SingleTickerProviderStateMixin {
  ...
  List<int> _deletedImageIds = []; // Untuk tracking gambar yang dihapus
  // File? _images;
  ...
  void _showGalleryDialog(BuildContext context, int startIndex) {
  showDialog(
    context: context,
                    ...
                    return Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            'Foto ${index + 1} dari ${_images.length}',
                            style: GoogleFonts.poppins(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  if (_images != null || _deletedImageIds != null)
                    _buildImageSourceOption(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if ((_images != null && _initialData!['foto'] != null) ||
                                            (_deletedImageIds == null && _initialData!['foto'] != null) ||
                                            (_deletedImageIds != null && _initialData!['foto'] == null))
                                          Padding(

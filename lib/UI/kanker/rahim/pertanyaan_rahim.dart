...
import 'package:primafit/UI/kanker/rahim/output_rahim.dart';
import 'package:primafit/UI/kanker/rahim/list_pertanyaan.dart';

class KankerRahimPage extends StatefulWidget {
  const KankerRahimPage({Key? key}) : super(key: key);

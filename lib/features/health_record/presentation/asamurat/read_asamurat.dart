...
import 'package:primafit/features/health_record/presentation/asamurat/update_asamurat.dart';
import 'package:primafit/features/health_record/presentation/asamurat/input_asamurat.dart';

class ReadAsamUratScreen extends StatefulWidget {
  const ReadAsamUratScreen({super.key});
...
class _ReadAsamUratScreenState extends State<ReadAsamUratScreen> with SingleTickerProviderStateMixin {
  ...
  Map<String, dynamic> _getAsamUratStatus(double value, {bool inMgdL = true}) {
    ...
    final double mgdLValue = inMgdL ? value : convertMicroMolLToMgdL(value);
                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final double valueInMgdL = item.getHasilInMgdL();
                                final double valueInMicroMolL = item.getHasilInMicroMolL();

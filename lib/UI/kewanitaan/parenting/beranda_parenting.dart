...
class ParentingHomePage extends StatefulWidget {
  const ParentingHomePage({Key? key}) : super(key: key);
...
class _ParentingHomePageState extends State<ParentingHomePage>
  ...
  Widget _buildQuickStatsSection() {
    ...
    final vaccinationProgress = _childStatistics['vaccination_progress'] ?? {};
    ...
    final totalVaccinations = vaccinationProgress['total_vaccinations'] ?? 0;
    final completedVaccinations = vaccinationProgress['completed_vaccinations'] ?? 0;
      ...
      child: Column(
        ...
        children: [
          ...
          if (_children.isEmpty) 
            ...
            ..._children.map((child) => _buildChildItem(child)).toList(),
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [
                  Colors.white,
                  const Color(0xFFE9458D).withOpacity(0.05),
                ],
              ),
            ),
            child: Column(

...
import 'package:primafit/features/health_wallet/presentation/vaksin/input_vaksin.dart';
import 'package:primafit/features/health_wallet/presentation/vaksin/edit_vaksin.dart';
...
class _VaksinListPageState extends State<VaksinListPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> filteredList = vaksinList.where((vaksin) {

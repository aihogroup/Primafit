...
class InputBpjsPage extends StatefulWidget {
  const InputBpjsPage({Key? key}) : super(key: key);

  @override
  State<InputBpjsPage> createState() => _InputBpjsPageState();
}

class _InputBpjsPageState extends State<InputBpjsPage> with SingleTickerProviderStateMixin {
                            ...
                            AnimatedContainer(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      'Silakan isi data Kartu BPJS Anda dengan lengkap',
                                      style: GoogleFonts.poppins(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w500,
                                      ),
            ...
            child: SafeArea(
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _isLoading ? null : _saveBpjs,

...
class NotificationService {
  ...
  Future<void> init() async {
    ...
    try {
      ...
      final String timezoneName = _getIanaTimeZone(hours, minutes);
  ...
  String _getIanaTimeZone(int hours, int minutes) {
    ...
    final String timezone = 'Etc/GMT${hours >= 0 ? '-' : '+'}${hours.abs()}';
  ...
  if (Platform.isAndroid) {
    ...
    if (sdkInt >= 33) {
      ...
      debugPrint('No need to request notification permission (Android SDK < 33)');
    }
  }
}

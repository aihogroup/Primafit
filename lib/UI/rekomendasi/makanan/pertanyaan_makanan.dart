...
import 'dart:async';
import 'package:primafit/database/rekomendasi/database_makanan.dart';
import 'package:primafit/UI/rekomendasi/makanan/output_makanan.dart';
import 'package:primafit/UI/rekomendasi/makanan/list_pertanyaan.dart';
...
class _NutritionAnalysisPageState extends State<NutritionAnalysisPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _animateToPreviousPage() async {
    ...
    setState(() {
      ...
      String questionId = NutritionQuestions.activeQuestions(_answers)[_currentPage]['id'];
  ...
  Widget _buildQuestionPage(Map<String, dynamic> question, int index) {
    ...
    String? inputType = NutritionQuestions.getInputTypeForQuestion(questionId);

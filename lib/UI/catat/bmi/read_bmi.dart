...
import 'package:primafit/UI/catat/bmi/update_bmi.dart';
import 'package:primafit/UI/catat/bmi/input_bmi.dart';

class ReadBmiScreen extends StatefulWidget {
  const ReadBmiScreen({Key? key}) : super(key: key);
...
class _ReadBmiScreenState extends State<ReadBmiScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildInfoPanel() {
    ...
    if (age < 20) {
      ...
      String ageRange;
      String genderText = (gender == 'laki-laki' || gender == 'pria') ? 'Laki-laki' : 'Perempuan';
                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                double heightCm = double.tryParse(item.tinggi) ?? 0;
                                double weightKg = double.tryParse(item.berat) ?? 0;
                                String heightInMeter = (heightCm / 100).toStringAsFixed(2);

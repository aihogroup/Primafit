...
import 'package:primafit/features/health_record/presentation/kolesterol/update_kolesterol.dart';
import 'package:primafit/features/health_record/presentation/kolesterol/input_kolesterol.dart';

class ReadKolesterolScreen extends StatefulWidget {
  const ReadKolesterolScreen({super.key});
...
Widget _buildInfoPanel() {
  ...
  String _getValueInSelectedUnit(String valueStr) {
    ...
    if (_showAsMgdL) {
      ...
      final double mmolValue = _convertMgdLToMmolL(value);
                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final double valueInMgdL = double.tryParse(item.hasil) ?? 0.0;

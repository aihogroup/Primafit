...
import 'package:primafit/UI/simpan/bpjs/input_bpjs.dart';
import 'package:primafit/UI/simpan/bpjs/edit_bpjs.dart';
...
class _BpjsListPageState extends State<BpjsListPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> filteredList = bpjsList.where((bpjs) {

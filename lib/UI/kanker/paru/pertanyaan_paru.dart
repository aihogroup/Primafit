...
import 'package:primafit/UI/kanker/paru/output_paru.dart';
import 'package:primafit/UI/kanker/paru/list_pertanyaan.dart';

class KankerParuPage extends StatefulWidget {
  const KankerParuPage({Key? key}) : super(key: key);

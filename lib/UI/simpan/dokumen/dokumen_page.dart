...
import 'package:primafit/UI/simpan/dokumen/input_dokumen.dart';
import 'package:primafit/UI/simpan/dokumen/edit_dokumen.dart';

class DokumenListPage extends StatefulWidget {
  const DokumenListPage({Key? key}) : super(key: key);
...
class _DokumenListPageState extends State<DokumenListPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> filteredList = dokumenList.where((dokumen) {

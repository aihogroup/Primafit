...
class UpdateKolesterolScreen extends StatefulWidget {
  final int kolesterolId;
  
  const UpdateKolesterolScreen({
    Key? key,
    required this.kolesterolId,
  }) : super(key: key);

  @override
  State<UpdateKolesterolScreen> createState() => _UpdateKolesterolScreenState();
}

class _UpdateKolesterolScreenState extends State<UpdateKolesterolScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadKolesterolData() async {
    try {
      final data = await KolesterolDatabaseHelper.instance.getKolesterolById(widget.kolesterolId);
      if (data != null) {
        setState(() {
          _currentData = data;
  ...
  void _updateData() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final updatedKolesterol = Kolesterol(
          id: widget.kolesterolId,
        ...
        await KolesterolDatabaseHelper.instance.updateKolesterol(updatedKolesterol);
                  ...
                  child: Padding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Perbarui data pemeriksaan kolesterol Anda',
                            style: GoogleFonts.poppins(
                              fontSize: 14,

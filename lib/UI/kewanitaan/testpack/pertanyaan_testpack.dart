...
import 'dart:async';
import 'package:primafit/database/kewanitaan/database_testpack.dart'; // Sesuaikan dengan path database Anda
import 'package:primafit/UI/kewanitaan/testpack/output_testpack.dart'; // Sesuaikan dengan path output Anda
import 'package:primafit/UI/kewanitaan/testpack/list_pertanyaan.dart'; // Sesuaikan dengan path list pertanyaan Anda

class KehamilanPage extends StatefulWidget {
  const KehamilanPage({Key? key}) : super(key: key);
  ...
  Widget _buildAnswerButton(String answer, String questionId) {
    ...
    return AnimatedContainer(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(12),
          splashColor: const Color(0xFFE9458D).withOpacity(0.1),
          highlightColor: const Color(0xFFE9458D).withOpacity(0.05),
          onTap: () {
            setState(() {
                          ...
                          AnimatedFractionallySizedBox(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: const Color(0xFFE9458D).withOpacity(0.4),
                                    blurRadius: 3,
                    ...
                    if (index < KehangilanQuestions.activeQuestions(_answers).length - 1)
                      ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          elevation: 0,
                          shadowColor: const Color(0xFFE9458D).withOpacity(0.3),

...
class InputTensiScreen extends StatefulWidget {
  const InputTensiScreen({Key? key}) : super(key: key);

  @override
  State<InputTensiScreen> createState() => _InputTensiScreenState();
}

class _InputTensiScreenState extends State<InputTensiScreen> with SingleTickerProviderStateMixin {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Pesan dialog
                Text(
                  'Data Tensi berhasil disimpan dalam database.',
  ...
  void _saveData() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await TekananDarahDatabaseHelper.instance.insertTekananDarah(Tensi);
...
Widget build(BuildContext context) {
  return WillPopScope(
    onWillPop: () async {
      ...
      bool formIsNotEmpty = _sistolikController.text.isNotEmpty || 

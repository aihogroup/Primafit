...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM15 10H13V15H11V10H9V8H11V6H13V8H15V10Z" fill="${primaryColor.toARGB32().toRadixString(16).substring(2)}" />
</svg>
  ''';

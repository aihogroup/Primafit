...
import 'package:primafit/UI/kanker/usus/output_usus.dart';
import 'package:primafit/UI/kanker/usus/list_pertanyaan.dart';

class KankerUsusPage extends StatefulWidget {
  const KankerUsusPage({Key? key}) : super(key: key);

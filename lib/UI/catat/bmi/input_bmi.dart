...
class InputBmiScreen extends StatefulWidget {
  const InputBmiScreen({Key? key}) : super(key: key);

  @override
  State<InputBmiScreen> createState() => _InputBmiScreenState();
}

class _InputBmiScreenState extends State<InputBmiScreen> with SingleTickerProviderStateMixin {
  ...
  void _saveData() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await IndeksMassaTubuhDatabaseHelper.instance.insertIndeksMassaTubuh(Bmi);
        print('BMI: $_bmiController');

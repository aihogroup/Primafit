...
import 'dart:io';
import 'package:primafit/UI/diagnosa/pencernaan/list_penyakit.dart';
...
class _OutputPageState extends State<OutputPage> with SingleTickerProviderStateMixin {
  ...
  Future<File> _generatePDF() async {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 20),
              if (_diagnosisResults.isNotEmpty && PenyakitPencernaan.penyakitInfo.containsKey(_diagnosisResults[0]['penyakit']))
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    pw.Text(
                    ...
                    pw.SizedBox(height: 5),
                    pw.Text(
                      PenyakitPencernaan.penyakitInfo[_diagnosisResults[0]['penyakit']]!['description'] ?? '',
                    ),
                    ...
                    pw.SizedBox(height: 5),
                    pw.Text(
                      PenyakitPencernaan.penyakitInfo[_diagnosisResults[0]['penyakit']]!['treatment'] ?? '',
                    ),
                  ],
                ),
            ],
    ...
    final file = File('${output.path}/hasil_diagnosa_Pencernaan.pdf');
  ...
  Future<void> _shareResults() async {
    try {
      ...
      await Share.shareXFiles(
        [XFile(pdfFile.path)],
        text: 'Hasil Diagnosa Penyakit Pencernaan',
        subject: 'Hasil Diagnosa Penyakit Pencernaan - ${DateFormat('dd MMM yyyy').format(DateTime.now())}',
      );
    } catch (e) {
  ...
  Future<void> _loadDiagnosisResults() async {
    try {
      ...
      print('Error loading diagnosis results: $e');
    }
  }
  ...
  Widget _buildResultCard(Map<String, dynamic> result) {
    ...
    final Map<String, String>? info = PenyakitPencernaan.penyakitInfo[penyakit];
              ...
              : SafeArea(
                  child: ListView(
                    ...
                    children: [
                      ...
                      //       opacity: _fadeAnimation,
                      //       child: _buildResultCard(_diagnosisResults[index]),
                      //     );
                      //   }),

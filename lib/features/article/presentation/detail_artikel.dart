...
import 'package:primafit/features/article/data/database_artikel.dart';
...
class _DetailArtikelPageState extends State<DetailArtikelPage> {
  ...
  debugPrint('Mencoba membuka URL: $url');
  ...
  Widget build(BuildContext context) {
    ...
    if (content.isNotEmpty) {
      ...
      final String cleanContent = content.replaceAll(RegExp(r'\[\+\d+ chars\]'), '');
                  ...
                  background: Stack(
                    ...
                    children: [
                      ...
                      urlToImage.isNotEmpty
                          ...
                          : Container(
                              color: const Color(0xFF64D1DE).withValues(alpha: 0.8),
                              child: const Center(

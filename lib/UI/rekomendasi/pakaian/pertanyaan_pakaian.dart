...
import 'dart:async';
import 'package:primafit/database/rekomendasi/database_fashion.dart';
import 'package:primafit/UI/rekomendasi/pakaian/output_pakaian.dart';
import 'package:primafit/UI/rekomendasi/pakaian/list_pertanyaan.dart';

class FashionAnalysisPage extends StatefulWidget {
  const FashionAnalysisPage({Key? key}) : super(key: key);
...
class _FashionAnalysisPageState extends State<FashionAnalysisPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _animateToPreviousPage() async {
    ...
    setState(() {
      ...
      String questionId = FashionQuestions.activeQuestions(_answers)[_currentPage]['id'];
  ...
  Widget _buildQuestionPage(Map<String, dynamic> question, int index) {
    ...
    String? inputType = FashionQuestions.getInputTypeForQuestion(questionId);

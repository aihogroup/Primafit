...
import 'package:primafit/features/health_record/data/database_asamurat.dart';

class InputAsamUratScreen extends StatefulWidget {
  const InputAsamUratScreen({super.key});

  @override
  State<InputAsamUratScreen> createState() => _InputAsamUratScreenState();
}

class _InputAsamUratScreenState extends State<InputAsamUratScreen> with SingleTickerProviderStateMixin {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Pesan dialog
                Text(
                  'Data asam urat berhasil disimpan dalam database.',
  ...
  void _saveData() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await AsamUratDatabaseHelper.instance.insertAsamUrat(asamurat);
                        ...
                        Expanded(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: _selectedUnit == 'mg/dL' ? 'Contoh: 5.4' : 'Contoh: 320',

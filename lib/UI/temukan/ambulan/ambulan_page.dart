...
class AmbulanPage extends StatefulWidget {
  const AmbulanPage({Key? key}) : super(key: key);
...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5H15V3H9v2H6.5c-.66 0-1.21.42-1.42 1.01L3 12v8c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h12v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-8l-2.08-5.99zM6.85 7h10.29l1.08 3.11H5.77L6.85 7zM19 17H5v-5h14v5z" fill="${primaryColor.value.toRadixString(16).substring(2)}"/>
  <circle cx="7.5" cy="14.5" r="1.5" fill="${primaryColor.value.toRadixString(16).substring(2)}"/>
  <circle cx="16.5" cy="14.5" r="1.5" fill="${primaryColor.value.toRadixString(16).substring(2)}"/>
  <path d="M15 11V6h-2v5H8l4 4 4-4h-1z" fill="${primaryColor.value.toRadixString(16).substring(2)}"/>
</svg>
  ''';
...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="M20 15.5c-1.25 0-2.45-.2-3.57-.57-.35-.11-.74-.03-1.02.24l-2.2 2.2c-2.83-1.44-5.15-3.75-6.59-6.59l2.2-2.21c.28-.26.36-.65.25-1C8.7 6.45 8.5 5.25 8.5 4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1zM19 12h2c0-4.97-4.03-9-9-9v2c3.87 0 7 3.13 7 7zm-4 0h2c0-2.76-2.24-5-5-5v2c1.66 0 3 1.34 3 3z" fill="${primaryColor.value.toRadixString(16).substring(2)}"/>
</svg>
  ''';

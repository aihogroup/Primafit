...
class _HospitalPageState extends State<HospitalPage> with TickerProviderStateMixin {
  ...
  Future<void> _openNearestHospitals() async {
  ...
  try {
    ...
    // Construct Google Maps URL for nearby hospitals, clinics, and puskesmas
    final Uri mapsUrl = Uri.parse(
      'https://www.google.com/maps/search/hospitals+OR+rumah+sakit+OR+klinik+OR+puskesmas/@${_currentPosition!.latitude},'
    ...
    _showErrorDialog('Gagal mencari lokasi fasilitas kesehatan: ${e.toString()}');
  } finally {
    if (mounted) {
      setState(() {
        _isLoading = false;
  ...
  // SVG string for hospital icon
  // ignore: unused_element
  String get _hospitalIconSvg => '''
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM15 10H13V15H11V10H9V8H11V6H13V8H15V10Z" fill="${primaryColor.value.toRadixString(16).substring(2)}" />
</svg>
  ''';
...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="M12 2C8.13 2 5 5.13 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.13 15.87 2 12 2ZM12 11.5C10.62 11.5 9.5 10.38 9.5 9C9.5 7.62 10.62 6.5 12 6.5C13.38 6.5 14.5 7.62 14.5 9C14.5 10.38 13.38 11.5 12 11.5Z" fill="${primaryColor.value.toRadixString(16).substring(2)}" />
</svg>
  ''';
                ...
                child: ScaleTransition(
                  ...
                  child: FadeTransition(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Hospital Icon using SVG with pulse animation
                        AnimatedBuilder(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'Temukan rumah sakit terdekat dengan lokasi Anda saat ini',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontFamily: 'Poppins',
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          borderRadius: BorderRadius.circular(16),
                          onTap: _isLoading ? null : _openNearestHospitals,
...
class BackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      ...
      size.width * 0.25,
      Paint()..color = primaryColor.withOpacity(0.07),
    );

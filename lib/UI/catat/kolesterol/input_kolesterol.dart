...
import 'package:primafit/UI/catat/kolesterol/read_kolesterol.dart';
import 'package:primafit/database/catat/database_kolesterol.dart';

class InputKolesterolScreen extends StatefulWidget {
  const InputKolesterolScreen({Key? key}) : super(key: key);

  @override
  State<InputKolesterolScreen> createState() => _InputKolesterolScreenState();
}

class _InputKolesterolScreenState extends State<InputKolesterolScreen> with SingleTickerProviderStateMixin {
  ...
  String _selectedUnit = 'mg/dL'; // Default satuan
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Pesan dialog
                Text(
                  'Data kolesterol berhasil disimpan dalam database.',
  ...
  void _saveData() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final kolesterol = Kolesterol(
          tanggal: formattedDate,
          waktu: formattedTime,
          hasil: _hasilController.text,
          catatan: _catatanController.text,
          satuan: _selectedUnit, // Tambahkan satuan yang dipilih
        );
        
        await KolesterolDatabaseHelper.instance.insertKolesterol(kolesterol);
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      'Hasil Periksa Kadar Kolesterol Total',
                      style: GoogleFonts.poppins(
                        fontSize: 16,
                        fontWeight: FontWeight.w500,
                      ),
                    ...
                    const SizedBox(height: 8),
                    // Ganti TextFormField tunggal dengan Row yang berisi TextFormField dan Dropdown
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Input nilai asam urat
                        Expanded(
                          flex: 2,
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: _selectedUnit == 'mg/dL' ? 'Contoh: 167' : 'Contoh: 9.3',
                            ...
                            validator: (value) {
                              ...
                              if (double.parse(value) < 0) {
                                return 'Hasil tidak boleh bernilai negatif';
                              }
                              return null;
                            },
                          ),
                          ...
                          child: Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                value: _selectedUnit, // Tambahkan state untuk satuan yang dipilih
                                ...
                                items: [
                                  DropdownMenuItem(
                                    value: 'mg/dL',
                                    child: Text('mg/dL', style: GoogleFonts.poppins()),
                                  ),
                                  DropdownMenuItem(
                                    value: 'µmol/L',
                                    child: Text('µmol/L', style: GoogleFonts.poppins()),
                                  ),
                                ],
                                onChanged: (value) {
                                  setState(() {

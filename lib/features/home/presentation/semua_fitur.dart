...
import 'dart:async';
import 'package:primafit/features/home/data/database_fitur.dart';
...
class _SemuaFiturPageState extends State<SemuaFiturPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildFeatureSection(CategoryData category, int sectionIndex, {bool forReorderable = false}) {
    ...
    if (category.isHidden && _isEditMode) {
      final Widget hiddenCategoryTile = _buildHiddenCategoryTile(category, sectionIndex);
      return forReorderable 
        ? hiddenCategoryTile 
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: item.isHidden ? Colors.grey.shade300 : primaryColor.withValues(alpha: 0.8),
                        shape: BoxShape.circle,
                      ),
                      child: Icon(
